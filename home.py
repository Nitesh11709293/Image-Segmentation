...
def front():
    ...
    label=Label(top,image=photo1)
    label.place(x=60,y=5)

    label1=Label(top,text="MACHINE LEARNING PROJECT",font=('bold',40))
